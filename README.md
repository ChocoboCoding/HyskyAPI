...
The root of the API is at https://hyskyapi.cc/apihandle.php
...
```https://hyskyapi.cc/apihandle.php?req=top```

**This will return the (first 200) most expensive auctions.**

---

```https://hyskyapi.cc/apihandle.php?req=search&query={SEARCH_QUERY}```
